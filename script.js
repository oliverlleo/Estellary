...
window.onload = function() {
    ...
    function updatePlayer() {
        ...
        Object.values(playerEffects).forEach(effect => { if (effect.cooldown > 0) effect.cooldown--; if (effect.duration > 0) effect.duration--; });
    ...
    // Adiciona os listeners de input globais
